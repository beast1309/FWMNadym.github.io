$(function () {
    ...
    $(document.querySelector('.waters__table-header__img.search')).on('mouseover', function () {
        $(document.querySelector('.waters__table-header__text.search')).toggleClass('--active')
    })
    $(document.querySelector('.waters__table-header__img.search')).on('mouseout', function () {
        $(document.querySelector('.waters__table-header__text.search')).removeClass('--active')
    })
    ...
    $('#alert').on('click', function () {
        let conf = confirm('подтвердите необходимость уведомления личного состава')
        console.log(conf)
    })
    /* <-- вызов меню */
    ...
    /* функции планшета водоисточников --> */
    $(document.querySelectorAll('#waters-table-row')).toggleClass('--active')

    $('#type').on('click', function () {
        $('#typeSortAll').toggleClass('--active')
        $('#typeSortPG').toggleClass('--active')
        $('#typeSortPW').toggleClass('--active')
    })

    $('#typeSortAll').on('click', function () {
        $('#typeSortAll').removeClass('--active')
        $('#typeSortPG').removeClass('--active')
        $('#typeSortPW').removeClass('--active')

        const rows = document.querySelectorAll('#waters-table-row')
        rows.forEach((row) => {
    ...
    $('#typeSortPG').on('click', function () {
        $('#typeSortAll').removeClass('--active')
        $('#typeSortPG').removeClass('--active')
        $('#typeSortPW').removeClass('--active')

        const rows = document.querySelectorAll('#waters-table-row')
        const proof = 'Гидрант'.toLowerCase().trim()
        rows.forEach((row) => {
            $(row).removeClass('--active')
            const type = document.querySelectorAll('#waters-table-type')
            type.forEach((item) => {
                if (row.contains(item) && item.innerText.toLowerCase().trim() == proof) {
    ...
    $('#typeSortPW').on('click', function () {
        $('#typeSortAll').removeClass('--active')
        $('#typeSortPG').removeClass('--active')
        $('#typeSortPW').removeClass('--active')

        const rows = document.querySelectorAll('#waters-table-row')
        const proof = 'Водоём'.toLowerCase().trim()
        rows.forEach((row) => {
            $(row).removeClass('--active')
            const type = document.querySelectorAll('#waters-table-type')
            type.forEach((item) => {
    ...
    $('#search').on('keyup', function () {
        ...
        rows.forEach((row) => {
            $(row).removeClass('--active')
            const places = document.querySelectorAll('#waters-table-place')
            places.forEach((item) => {
                if (row.contains(item) && item.innerText.toLowerCase().trim().includes(search.value)) {
                    $(row).toggleClass('--active')
                }
            })
        })
    ...
    function init() {
        ...
        myMap.geoObjects
            ...
            .add(new ymaps.Placemark([65.849295, 74.474673], {
                ...
                balloonContentFooter: '<img src="./images/waterObjects/10.jpg" height="225" width="300">',
                iconCaption: 'ПГ-10'
            }, {
            ...
            .add(new ymaps.Placemark([65.849849, 74.475851], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/11.jpg" height="225" width="300">',
                iconCaption: 'ПГ-11'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.849059, 74.471988], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/12.jpg" height="225" width="300">',
                iconCaption: 'ПГ-12'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.848000, 74.471795], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/9.jpg" height="225" width="300">',
                iconCaption: 'ПГ-9'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859503, 74.501579], {
                ...
                balloonContentFooter: '<img src="./images/waterObjects/51.jpg" height="225" width="300">',
                iconCaption: 'ПГ-51'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860965, 74.500286], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/57.jpg" height="225" width="300">',
                iconCaption: 'ПГ-57'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.86059, 74.504193], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/53.jpg" height="225" width="300">',
                iconCaption: 'ПГ-53'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.861491, 74.501885], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/56.jpg" height="225" width="300">',
                iconCaption: 'ПГ-56'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860061, 74.504790], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/pg-kek.jpg" height="225" width="300">',
                iconCaption: 'ПГ-52'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860135, 74.502734], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/54.jpg" height="225" width="300">',
                iconCaption: 'ПГ-54'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860544, 74.501494], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/55.jpg" height="225" width="300">',
                iconCaption: 'ПГ-55'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.861203, 74.496951], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/88.jpg" height="225" width="300">',
                iconCaption: 'ПГ-88'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859904, 74.500386], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/8.jpg" height="225" width="300">',
                iconCaption: 'ПГ-8'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.858945, 74.497512], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/58.jpg" height="225" width="300">',
                iconCaption: 'ПГ-58'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859145, 74.498715], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/59.jpg" height="225" width="300">',
                iconCaption: 'ПГ-59'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.853109, 74.484775], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/120.jpg" height="225" width="300">',
                iconCaption: 'ПГ-120'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.856806, 74.494603], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/112.jpg" height="225" width="300">',
                iconCaption: 'ПГ-112'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857832, 74.497343], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/111.jpg" height="225" width="300">',
                iconCaption: 'ПГ-111'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.855646, 74.491541], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/42.jpg" height="225" width="300">',
                iconCaption: 'ПГ-42'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.855196, 74.492420], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/44.jpg" height="225" width="300">',
                iconCaption: 'ПГ-44'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.858629, 74.499456], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/110.jpg" height="225" width="300">',
                iconCaption: 'ПГ-110'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.850384, 74.479550], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/20.jpg" height="225" width="300">',
                iconCaption: 'ПГ-20'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.851534, 74.480542], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/19.jpg" height="225" width="300">',
                iconCaption: 'ПГ-19'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.852269, 74.484810], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/21.jpg" height="225" width="300">',
                iconCaption: 'ПГ-21'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857066, 74.500021], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/148.jpg" height="225" width="300">',
                iconCaption: 'ПГ-148'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.851783, 74.489254], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/137.jpg" height="225" width="300">',
                iconCaption: 'ПГ-137'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.852163, 74.490238], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/139.jpg" height="225" width="300">',
                iconCaption: 'ПГ-139'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.850461, 74.483441], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/108.jpg" height="225" width="300">',
                iconCaption: 'ПГ-108'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857715, 74.504587], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/145.jpg" height="225" width="300">',
                iconCaption: 'ПГ-145'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854036, 74.495159], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/46.jpg" height="225" width="300">',
                iconCaption: 'ПГ-46'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.855020, 74.497669], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/49.jpg" height="225" width="300">',
                iconCaption: 'ПГ-49'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854351, 74.495989], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/47.jpg" height="225" width="300">',
                iconCaption: 'ПГ-47'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.856825, 74.502164], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/144.jpg" height="225" width="300">',
                iconCaption: 'ПГ-144'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.850313, 74.485106], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/125.jpg" height="225" width="300">',
                iconCaption: 'ПГ-125'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.852782, 74.491889], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/28.jpg" height="225" width="300">',
                iconCaption: 'ПГ-28'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854629, 74.496731], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/48.jpg" height="225" width="300">',
                iconCaption: 'ПГ-48'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854097, 74.491522], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/30.jpg" height="225" width="300">',
                iconCaption: 'ПГ-30'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854712, 74.495182], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/45.jpg" height="225" width="300">',
                iconCaption: 'ПГ-45'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.855612, 74.496433], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/50.jpg" height="225" width="300">',
                iconCaption: 'ПГ-50'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854976, 74.494828], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/43.jpg" height="225" width="300">',
                iconCaption: 'ПГ-43'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.851196, 74.484787], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/22.jpg" height="225" width="300">',
                iconCaption: 'ПГ-22'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860718, 74.495094], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/128.jpg" height="225" width="300">',
                iconCaption: 'ПГ-128'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.860236, 74.495029], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/129.jpg" height="225" width="300">',
                iconCaption: 'ПГ-129'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.851673, 74.475978], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/15.jpg" height="225" width="300">',
                iconCaption: 'ПГ-15'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.858570, 74.493859], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/40.jpg" height="225" width="300">',
                iconCaption: 'ПГ-40'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.858938, 74.491200], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/36.jpg" height="225" width="300">',
                iconCaption: 'ПГ-36'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857214, 74.486701], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/34.jpg" height="225" width="300">',
                iconCaption: 'ПГ-34'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.852758, 74.474442], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/17.jpg" height="225" width="300">',
                iconCaption: 'ПГ-17'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857152, 74.486042], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/33.jpg" height="225" width="300">',
                iconCaption: 'ПГ-33'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854953, 74.481048], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/122.jpg" height="225" width="300">',
                iconCaption: 'ПГ-122'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.858185, 74.489221], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/35.jpg" height="225" width="300">',
                iconCaption: 'ПГ-35'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.856739, 74.482979], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/26.jpg" height="225" width="300">',
                iconCaption: 'ПГ-26'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.853627, 74.475736], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/23.jpg" height="225" width="300">',
                iconCaption: 'ПГ-23'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859152, 74.493284], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/39.jpg" height="225" width="300">',
                iconCaption: 'ПГ-39'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.857828, 74.491398], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/38.jpg" height="225" width="300">',
                iconCaption: 'ПГ-38'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.856610, 74.489789], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/37.jpg" height="225" width="300">',
                iconCaption: 'ПГ-37'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.853407, 74.479750], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/106.jpg" height="225" width="300">',
                iconCaption: 'ПГ-106'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.853812, 74.478856], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/109.jpg" height="225" width="300">',
                iconCaption: 'ПГ-109'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.852380, 74.474386], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/16.jpg" height="225" width="300">',
                iconCaption: 'ПГ-16'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859712, 74.495963], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/130.jpg" height="225" width="300">',
                iconCaption: 'ПГ-130'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.859328, 74.495487], {
                ...
                balloonContentBody: 'Тип: наружний;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/131.jpg" height="225" width="300">',
                iconCaption: 'ПГ-131'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854911, 74.483821], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/27.jpg" height="225" width="300">',
                iconCaption: 'ПГ-27'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.853383, 74.491033], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/29.jpg" height="225" width="300">',
                iconCaption: 'ПГ-29'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.854339, 74.488040], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/31.jpg" height="225" width="300">',
                iconCaption: 'ПГ-31'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.855396, 74.486436], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/32.jpg" height="225" width="300">',
                iconCaption: 'ПГ-32'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.851567, 74.474375], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/14.jpg" height="225" width="300">',
                iconCaption: 'ПГ-14'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.849286, 74.477380], {
                ...
                balloonContentFooter: '<img src="./images/waterObjects/7.jpg" height="225" width="300">',
                iconCaption: 'ПГ-7'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.848059, 74.476498], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/6.jpg" height="225" width="300">',
                iconCaption: 'ПГ-6'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.847228, 74.472522], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/4.jpg" height="225" width="300">',
                iconCaption: 'ПГ-4'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
            ...
            .add(new ymaps.Placemark([65.847425, 74.474653], {
                ...
                balloonContentBody: 'Тип: подземный;<br>Система: кольцевая',
                balloonContentFooter: '<img src="./images/waterObjects/5.jpg" height="225" width="300">',
                iconCaption: 'ПГ-5'
            }, {
                preset: 'islands#blueCircleDotIconWithCaption',
                iconCaptionMaxWidth: '50'
    ...
    let tempResponse = fetch(`https://api.weatherapi.com/v1/current.json?key=d91aebb7dc8a467fbd9193631242706&q=65.854576,74.487753&aqi=yes`, {})
    ...
    let coundResponse = fetch(`https://api.weatherapi.com/v1/marine.json?q=65.533142%2C72.528935&days=1&lang=ru&key=d91aebb7dc8a467fbd9193631242706`, {})
        ...
        .then(coundResponse => {
            ...
            else if (coundResponseText.toLowerCase().includes('дожд') || coundResponseText.toLowerCase().includes('гроза') || coundResponseText.toLowerCase().includes('слабая морос')) {
        ...
        .then(windResponse => {
            ...
            switch (windDir) {
                ...
                case 'WSW': windDir = 'ЗЮЗ'
                    break
                case 'ENE': windDir = 'ВСВ'
                    break
                case 'ESE': windDir = 'ВЮВ'
                    break
                case 'SSW': windDir = 'ЮЮЗ'
                    break
                case 'SSE': windDir = 'ЮЮВ'
                    break
                default: windDir = ''
                    break
            }
    ...
    $('#tactic-12').on('click', function () {
        $('#tacticInfo-12').toggleClass('--acitve')
    })
    $('#tactic-13').on('click', function () {
        $('#tacticInfo-13').toggleClass('--acitve')
    })
    $('#tactic-14').on('click', function () {
        $('#tacticInfo-14').toggleClass('--acitve')
    })
    $('#tactic-15').on('click', function () {
        $('#tacticInfo-15').toggleClass('--acitve')
    })
    $('#tactic-16').on('click', function () {
        $('#tacticInfo-16').toggleClass('--acitve')
    })
    $('#tactic-17').on('click', function () {
        $('#tacticInfo-17').toggleClass('--acitve')
    })
    $('#tactic-18').on('click', function () {
        $('#tacticInfo-18').toggleClass('--acitve')
    })
    $('#tactic-19').on('click', function () {
        $('#tacticInfo-19').toggleClass('--acitve')
    })
    $('#tactic-20').on('click', function () {
        $('#tacticInfo-20').toggleClass('--acitve')
    })
    $('#tactic-21').on('click', function () {
        $('#tacticInfo-21').toggleClass('--acitve')
    })
    $('#tactic-22').on('click', function () {
        $('#tacticInfo-22').toggleClass('--acitve')
    })
    /*<-- база знаний */
});